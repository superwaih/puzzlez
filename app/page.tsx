...
export default function GamesPage() {
  ...
  return (
    <main className="h-dvh overflow-hidden p-4 max-[1060px]:h-auto max-[1060px]:min-h-dvh max-[1060px]:overflow-auto">
      <div className="h-full max-w-[1200px] mx-auto grid grid-cols-[minmax(0,1fr)_320px] gap-3.5 max-[1060px]:h-auto max-[1060px]:grid-cols-1">
        <section className="border border-white/[0.12] rounded-[18px] bg-white/[0.04] min-h-0 grid grid-rows-[auto_1fr] gap-3.5 p-3.5">
          <div className="flex flex-wrap justify-between gap-2.5">
            <h1 className="m-0 text-[clamp(1.3rem,3vw,2rem)] font-medium">Puzzlez</h1>
            <div className="flex items-center flex-wrap gap-2">
              ...
              <button className="rounded-full border border-white/25 bg-transparent text-white py-2 px-3 disabled:opacity-40 disabled:cursor-not-allowed" onClick={openWithdrawModal} disabled={balance < 10000}>
                Withdraw
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm grid place-items-center p-4 z-40 animate-[fadeIn_0.3s_ease-out]" role="dialog" aria-modal="true">
          <div className="w-full max-w-[640px] rounded-3xl border  bg-gradient-to-b from-[#1c1a0e] via-[#121212] to-[#060606] p-8 text-center shadow-[0_0_80px_rgba(250,204,21,0.12)] animate-[popIn_0.4s_ease-out]">
            ...
            <div className="mt-4 inline-block rounded-full border border-yellow-400/20 bg-yellow-400/10 px-5 py-2">
              <span className="text-yellow-300 font-semibold text-lg">🎉 You just unlocked ₦5,000</span>
            </div>
      ...
      {withdrawOpen ? (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm grid place-items-center p-4 z-40" role="dialog" aria-modal="true">
          <div className="w-full max-w-[480px] rounded-2xl border border-white/10 bg-[#111] p-6 shadow-2xl">
            ...
            <div className="rounded-lg bg-white/[0.04] border border-white/[0.08] px-4 py-3 mb-5">
              <p className="m-0 text-white/50 text-xs uppercase tracking-wide">Available Balance</p>
              <p className="m-0 text-white text-xl font-semibold mt-0.5">{formatNaira(balance)}</p>
            </div>
